    ...
    <SafeAreaView style={styles.container}>
        <ScrollView>
            <KeyboardAvoidingView  style={{width: width, alignItems: 'center'}}>
                ...
                <TextField icon='md-person-sharp' returnKeyType='next' placeholder='Firstname' />
                <TextField icon='md-person-sharp' returnKeyType='next' placeholder='Lastname' />
                <TextField icon='md-mail' returnKeyType='next' placeholder='Email' />
                <TextField icon='md-phone-portrait-outline' returnKeyType='next' placeholder='Mobile Number' />
                <TextField icon='md-lock-closed' returnKeyType='next' placeholder='Create password' />
                <TextField icon='md-lock-closed' returnKeyType='done' placeholder='Confirm password' />
                <View style={{marginTop: '7%'}} />
                <CustomeBtn name='Sign up' onPress={signin} />
